...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
 ...
 /*
   ...
   └─────────┴─────────┴─────────┼─────────┼─────────┼─────────┼╰────────╯╰────────╯┼─────────┼─────────┼─────────┼─────────┴─────────┴─────────┘
                                 │  LALT   │  LOWER  │  SPACE  │   ESC   ││  ENTER  │ BKSPCE  │  RAISE  │    DEL  │
                                 └─────────┴─────────┴─────────┴─────────┘└─────────┴─────────┴─────────┴─────────┘ */
...
/*
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
               _______,  _______,  _______,  _______,  _______,                    DF(QWERTY),  _______,  _______,  _______,  _______,
 ...
 //╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷╷         ╷         ╷         ╷         ╷         ╷         ╷         ╷
              AU_TOGG,   HF_TOGG,  RGB_HUI,  RGB_MOD,  XXXXXXX,                     DF(_GAME),  KC_F7,    KC_F8,    KC_F9,    KC_F14,
...
int MAX_GAME_LAYER = 1;

bool encoder_udate_user(uint8_t index, bool clockwise) {
    if (index == 1 && layer_state_is(_GAME)) {
        if (clockwise) {
            if (current_game_layer < MAX_GAME_LAYER) {
                current_game_layer++;
            } else {
            ...
            if (current_game_layer > 0) {
                ...
                current_game_layer = MAX_GAME_LAYER;
            }
        }
    }
    return true;
